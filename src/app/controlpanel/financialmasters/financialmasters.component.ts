...
@Component({
  selector: 'app-financialmasters',
  templateUrl: './financialmasters.component.html',
  styleUrls: ['./financialmasters.component.scss']
})
export class FinancialmastersComponent implements OnInit {
